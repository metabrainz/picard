...
**Note:** Picard and Picard-Plugins code are currently in a state of flux due to development of Picard v3.
If you want to contribute by coding, then please discuss this with Phillip Wolfer or Zas before starting.
...
Tests live in the `test/` directory and use pytest. How to write them — the two
coexisting styles, the `subtest_cases` decorator for table-driven tests, and the
shared `qapp` fixture for Qt widgets — is documented in
...
- [JAudiotagger](https://www.jthink.net/jaudiotagger/tagmapping.html)
...
- [MusicBee](https://musicbee.fandom.com/wiki/Tag)
...
- [Foobar2000:ID3 Tag Mapping - Hydrogenaudio Knowledgebase](https://wiki.hydrogenaudio.org/index.php?title=Foobar2000:ID3_Tag_Mapping)
- [Tag Mapping - Hydrogenaudio Knowledgebase](https://wiki.hydrogenaudio.org/index.php?title=Tag_Mapping)
- [Windows](https://learn.microsoft.com/en-us/windows/win32/wmformat/id3-tag-support)
- [SlimServerSupportedTags - SqueezeboxWiki](https://wiki.slimdevices.com/index.php/SlimServerSupportedTags)
