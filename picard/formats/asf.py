...
# Copyright (C) 2009-2011, 2014, 2018-2021, 2023, 2026 Philipp Wolfer
# Copyright (C) 2011-2014 Wieland Hoffmann
# Copyright (C) 2012-2013 Michael Wiencek
# Copyright (C) 2013 Calvin Walton
# Copyright (C) 2013-2014, 2018-2021, 2023-2026 Laurent Monin
...
class ASFFile(File):
    ...
    __RTRANS = MappingProxyType({b: a for a, b in __TRANS.items()})

    # Tags to load case insensitive
    __TRANS_CI = MappingProxyType(
        {
    ...
    __RTRANS_CI = MappingProxyType({b.lower(): a for a, b in __TRANS_CI.items()})
