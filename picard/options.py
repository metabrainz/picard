...
BoolOption(
    'setting', READTHEDOCS_UPDATES_ALLOWED_KEY, False, title=N_("Check for documentation updates during startup")
)
...
BoolOption('setting', READTHEDOCS_UPDATES_ASK_KEY, True, N_("Show check for documentation updates during startup"))
