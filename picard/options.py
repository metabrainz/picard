...
BoolOption('setting', 'rtd_updates_ask', True, N_("Show documentation update request"), in_profile=True)
...
TextOption('setting', 'ui_language', '', title=N_("User interface language"), in_profile=True)
TextOption('setting', 'ui_theme', DEFAULT_THEME_NAME, title=N_("User interface color theme"), in_profile=True)
...
ListOption('persist', 'plugins3_do_not_update', [], title=N_("Plugins to exclude from updates"), in_profile=True)
