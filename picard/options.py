...
# Translation toggles
BoolOption('setting', 'translate_artist_names', True, title=N_("Translate artist names"))
BoolOption('setting', 'translate_album_names', False, title=N_("Translate album names"))
