...
ALIAS_LOCALES = {
    ...
    'zh_HK': N_('Chinese (Hong Kong SAR China)'),
    'zh_MO': N_('Chinese (Macau SAR China)'),
    'zh_Hans': N_('Chinese (Simplified Han)'),
    'zh_Hans_CN': N_('Chinese (Simplified Han) (China)'),
    'zh_Hans_HK': N_('Chinese (Simplified Han) (Hong Kong SAR China)'),
    'zh_Hans_MO': N_('Chinese (Simplified Han) (Macau SAR China)'),
    ...
    'zh_Hant_HK': N_('Chinese (Traditional Han) (Hong Kong SAR China)'),
    'zh_Hant_MO': N_('Chinese (Traditional Han) (Macau SAR China)'),
    ...
    'en_HK': N_('English (Hong Kong SAR China)'),
