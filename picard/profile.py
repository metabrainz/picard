...
class UserProfileGroups():
    ...
    SETTINGS_GROUPS["metadata"] = {
        ...
        "settings": [
            ...
            SettingDesc("translate_artist_names_script_exception", N_("Translate artist names script exception"), ["translate_artist_names_script_exception"]),
            SettingDesc("artist_script_exception", N_("Translation script exception"), ["artist_script_exception"]),
