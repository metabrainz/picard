...
from picard.extension_points.tools_test_menu import register_test_menu_action
...
class PluginApi:
    ...
    def register_test_menu_action(self, action: BaseAction) -> None:
        return register_test_menu_action(action, self)
