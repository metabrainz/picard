...
class Ui_InterfaceOptionsPage(object):
    def setupUi(self, InterfaceOptionsPage):
        ...
        self.show_menu_icons = QtWidgets.QCheckBox(self.groupBox_2)
        self.show_menu_icons.setObjectName("show_menu_icons")
        self.vboxlayout1.addWidget(self.show_menu_icons)
        ...
        InterfaceOptionsPage.setTabOrder(self.toolbar_multiselect, self.show_menu_icons)
        InterfaceOptionsPage.setTabOrder(self.show_menu_icons, self.builtin_search)
