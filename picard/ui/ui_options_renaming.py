...
class Ui_RenamingOptionsPage(object):
    def setupUi(self, RenamingOptionsPage):
        ...
        self.groupBox_2 = QtWidgets.QGroupBox(RenamingOptionsPage)
        self.groupBox_2.setMinimumSize(QtCore.QSize(0, 0))
        self.groupBox_2.setObjectName("groupBox_2")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.groupBox_2)
        self.verticalLayout_2.setContentsMargins(2, 0, 2, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.naming_script_selector = QtWidgets.QComboBox(self.groupBox_2)
        self.naming_script_selector.setObjectName("naming_script_selector")
        self.verticalLayout_2.addWidget(self.naming_script_selector)
    ...
    def retranslateUi(self, RenamingOptionsPage):
        ...
        self.groupBox_2.setTitle(_("Selected file naming script:"))
