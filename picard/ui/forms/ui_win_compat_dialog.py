...
class Ui_WinCompatDialog(object):
    def setupUi(self, WinCompatDialog):
        ...
        self.replace_questionmark.setMaximumSize(QtCore.QSize(40, 16777215))
        self.replace_questionmark.setText("_")
        self.replace_questionmark.setMaxLength(3)
        ...
        self.replace_asterisk.setMaximumSize(QtCore.QSize(40, 16777215))
        self.replace_asterisk.setText("_")
        self.replace_asterisk.setMaxLength(3)
        ...
        self.replace_gt.setMaximumSize(QtCore.QSize(40, 16777215))
        self.replace_gt.setText("_")
        self.replace_gt.setMaxLength(3)
        ...
        self.replace_lt.setMaximumSize(QtCore.QSize(40, 16777215))
        self.replace_lt.setText("_")
        self.replace_lt.setMaxLength(3)
        ...
        self.replace_pipe.setMaximumSize(QtCore.QSize(40, 16777215))
        self.replace_pipe.setText("_")
        self.replace_pipe.setMaxLength(3)
        ...
        self.replace_colon.setMaximumSize(QtCore.QSize(40, 16777215))
        self.replace_colon.setText("_")
        self.replace_colon.setMaxLength(3)
        ...
        self.replace_quotationmark.setMaximumSize(QtCore.QSize(40, 16777215))
        self.replace_quotationmark.setText("_")
        self.replace_quotationmark.setMaxLength(10)
