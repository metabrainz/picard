...
class Ui_NetworkOptionsPage(object):
    def setupUi(self, NetworkOptionsPage):
        ...
        self.horizontalLayout.addWidget(self.label_cache_size)
        self.current_cache_size = QtWidgets.QLabel(parent=self.networkopts)
        self.current_cache_size.setText("")
        self.current_cache_size.setObjectName("current_cache_size")
        self.horizontalLayout.addWidget(self.current_cache_size)
        self.label_cache_sep = QtWidgets.QLabel(parent=self.networkopts)
        self.label_cache_sep.setObjectName("label_cache_sep")
        self.horizontalLayout.addWidget(self.label_cache_sep)
        ...
        self.label_cache_max_unit = QtWidgets.QLabel(parent=self.networkopts)
        self.label_cache_max_unit.setObjectName("label_cache_max_unit")
        self.horizontalLayout.addWidget(self.label_cache_max_unit)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Policy.Expanding, QtWidgets.QSizePolicy.Policy.Minimum)
        self.horizontalLayout.addItem(spacerItem1)
        self.clear_network_cache = QtWidgets.QPushButton(parent=self.networkopts)
        self.clear_network_cache.setObjectName("clear_network_cache")
        self.horizontalLayout.addWidget(self.clear_network_cache)
        ...
        spacerItem2 = QtWidgets.QSpacerItem(101, 31, QtWidgets.QSizePolicy.Policy.Minimum, QtWidgets.QSizePolicy.Policy.Expanding)
        ...
        NetworkOptionsPage.setTabOrder(self.transfer_timeout, self.network_cache_size)
    ...
    def retranslateUi(self, NetworkOptionsPage):
        ...
        self.label_cache_size.setText(_("Cache usage:"))
        self.label_cache_sep.setText(_(" / "))
        self.label_cache_max_unit.setText(_(" MB"))
        self.clear_network_cache.setText(_("Clear cache"))
