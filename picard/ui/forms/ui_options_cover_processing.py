...
class Ui_CoverProcessingOptionsPage(object):
    def setupUi(self, CoverProcessingOptionsPage):
        ...
        self.image_quality_label = QtWidgets.QLabel(parent=CoverProcessingOptionsPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.image_quality_label.sizePolicy().hasHeightForWidth())
        self.image_quality_label.setSizePolicy(sizePolicy)
        self.image_quality_label.setWordWrap(False)
        self.image_quality_label.setObjectName("image_quality_label")
        self.horizontalLayout_8.addWidget(self.image_quality_label)
        self.cover_quality_value = QtWidgets.QSpinBox(parent=CoverProcessingOptionsPage)
        self.cover_quality_value.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.cover_quality_value.setMinimum(50)
        self.cover_quality_value.setMaximum(100)
        self.cover_quality_value.setProperty("value", 90)
        self.cover_quality_value.setObjectName("cover_quality_value")
        self.horizontalLayout_8.addWidget(self.cover_quality_value)
    ...
    def retranslateUi(self, CoverProcessingOptionsPage):
        ...
        self.image_quality_label.setText(_("Processed image quality:"))
