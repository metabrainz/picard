...
class Ui_CoverProcessingOptionsPage(object):
    def setupUi(self, CoverProcessingOptionsPage):
        ...
        self.file_scale_down.setChecked(False)
        ...
        self.cover_image_quality_label = QtWidgets.QLabel(parent=CoverProcessingOptionsPage)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.cover_image_quality_label.sizePolicy().hasHeightForWidth())
        self.cover_image_quality_label.setSizePolicy(sizePolicy)
        self.cover_image_quality_label.setWordWrap(False)
        self.cover_image_quality_label.setObjectName("cover_image_quality_label")
        self.horizontalLayout_8.addWidget(self.cover_image_quality_label)
        self.cover_image_quality_value = QtWidgets.QSpinBox(parent=CoverProcessingOptionsPage)
        self.cover_image_quality_value.setAlignment(QtCore.Qt.AlignmentFlag.AlignRight|QtCore.Qt.AlignmentFlag.AlignTrailing|QtCore.Qt.AlignmentFlag.AlignVCenter)
        self.cover_image_quality_value.setMinimum(0)
        self.cover_image_quality_value.setMaximum(100)
        self.cover_image_quality_value.setProperty("value", 90)
        self.cover_image_quality_value.setObjectName("cover_image_quality_value")
        self.horizontalLayout_8.addWidget(self.cover_image_quality_value)
        self.percent_label = QtWidgets.QLabel(parent=CoverProcessingOptionsPage)
        self.percent_label.setText("%")
        self.percent_label.setObjectName("percent_label")
        self.horizontalLayout_8.addWidget(self.percent_label)
