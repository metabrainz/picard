...
class Ui_MetadataOptionsPage(object):
    def setupUi(self, MetadataOptionsPage):
        ...
        self.always_standardize_multivalue_artist = QtWidgets.QCheckBox(parent=self.metadata_groupbox)
        self.always_standardize_multivalue_artist.setObjectName("always_standardize_multivalue_artist")
        self.verticalLayout_3.addWidget(self.always_standardize_multivalue_artist)
    ...
    def retranslateUi(self, MetadataOptionsPage):
        ...
        self.always_standardize_multivalue_artist.setText(_("Always standardize multi-valued artist tags"))
