...
class Ui_MetadataOptionsPage(object):
    def setupUi(self, MetadataOptionsPage):
        ...
        MetadataOptionsPage.resize(423, 726)
        ...
        self.standardize_artist_names_label = QtWidgets.QLabel(parent=self.metadata_groupbox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.MinimumExpanding, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.standardize_artist_names_label.sizePolicy().hasHeightForWidth())
        self.standardize_artist_names_label.setSizePolicy(sizePolicy)
        self.standardize_artist_names_label.setObjectName("standardize_artist_names_label")
        self.horizontalLayout_2.addWidget(self.standardize_artist_names_label)
        self.standardize_artist_names = QtWidgets.QComboBox(parent=self.metadata_groupbox)
        self.standardize_artist_names.setObjectName("standardize_artist_names")
        self.horizontalLayout_2.addWidget(self.standardize_artist_names)
        self.verticalLayout_3.addLayout(self.horizontalLayout_2)
        self.force_standardize_multivalue_artist = QtWidgets.QCheckBox(parent=self.metadata_groupbox)
        self.force_standardize_multivalue_artist.setObjectName("force_standardize_multivalue_artist")
        self.verticalLayout_3.addWidget(self.force_standardize_multivalue_artist)
        ...
        self.translations_groupbox = QtWidgets.QGroupBox(parent=MetadataOptionsPage)
        self.translations_groupbox.setObjectName("translations_groupbox")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.translations_groupbox)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        self.translation_prompt_label = QtWidgets.QLabel(parent=self.translations_groupbox)
        self.translation_prompt_label.setObjectName("translation_prompt_label")
        self.verticalLayout_2.addWidget(self.translation_prompt_label)
        ...
        self.translate_artist_names = QtWidgets.QCheckBox(parent=self.translations_groupbox)
        ...
        self.translate_album_titles = QtWidgets.QCheckBox(parent=self.translations_groupbox)
        self.translate_album_titles.setObjectName("translate_album_titles")
        self.translation_options_layout.addWidget(self.translate_album_titles)
        self.translate_track_titles = QtWidgets.QCheckBox(parent=self.translations_groupbox)
        ...
        self.verticalLayout_2.addLayout(self.translation_options_layout)
        ...
        self.locales_prompt_label = QtWidgets.QLabel(parent=self.translations_groupbox)
        ...
        self.selected_locales = QtWidgets.QLineEdit(parent=self.translations_groupbox)
        ...
        self.select_locales = QtWidgets.QPushButton(parent=self.translations_groupbox)
        ...
        self.verticalLayout_2.addLayout(self.locales_container)
        ...
        self.translate_artist_names_script_exception = QtWidgets.QCheckBox(parent=self.translations_groupbox)
        ...
        self.selected_scripts = QtWidgets.QLineEdit(parent=self.translations_groupbox)
        ...
        self.select_scripts = QtWidgets.QPushButton(parent=self.translations_groupbox)
        ...
        self.verticalLayout_2.addLayout(self.translation_language_containers)
        self.translate_from_sortname = QtWidgets.QCheckBox(parent=self.translations_groupbox)
        self.translate_from_sortname.setObjectName("translate_from_sortname")
        self.verticalLayout_2.addWidget(self.translate_from_sortname)
        self.verticalLayout.addWidget(self.translations_groupbox)
        ...
        self.standardize_artist_names_label.setBuddy(self.standardize_artist_names)
        ...
        MetadataOptionsPage.setTabOrder(self.force_standardize_multivalue_artist, self.standardize_instruments)
        ...
        MetadataOptionsPage.setTabOrder(self.guess_tracknumber_and_title, self.translate_artist_names)
        ...
        MetadataOptionsPage.setTabOrder(self.translate_from_sortname, self.va_name)
    ...
    def retranslateUi(self, MetadataOptionsPage):
        ...
        self.standardize_artist_names_label.setText(_("Standardize artist names:"))
        self.force_standardize_multivalue_artist.setText(_("Force standarization for multi-valued artist tags"))
        ...
        self.translations_groupbox.setTitle(_("Translations"))
