...
class Ui_FingerprintingOptionsPage(object):
    def setupUi(self, FingerprintingOptionsPage):
        ...
        self.acoustid_fpcalc_browse.setStyleSheet("border: none;")
        self.acoustid_fpcalc_browse.setText("")
        ...
        self.label_3.setBuddy(self.fpcalc_threads)
    ...
    def retranslateUi(self, FingerprintingOptionsPage):
        ...
        self.acoustid_fpcalc_browse.setToolTip(_("Select file in browser"))
