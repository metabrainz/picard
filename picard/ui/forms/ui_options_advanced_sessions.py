...
class Ui_SessionsOptionsPage(object):
    def setupUi(self, SessionsOptionsPage):
        ...
        self.saving_sessions_label = QtWidgets.QLabel(parent=SessionsOptionsPage)
        self.saving_sessions_label.setObjectName("saving_sessions_label")
        self.vboxlayout.addWidget(self.saving_sessions_label)
        ...
        self.child_layout.addItem(spacerItem3)
        ...
        self.loading_sessions_label = QtWidgets.QLabel(parent=SessionsOptionsPage)
        self.loading_sessions_label.setObjectName("loading_sessions_label")
        self.vboxlayout.addWidget(self.loading_sessions_label)
...
"These settings determine how the session files are managed."))
        ...
        self.loading_sessions_label.setText(_("Loading sessions:"))
