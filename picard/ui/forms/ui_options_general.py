...
class Ui_GeneralOptionsPage(object):
    def setupUi(self, GeneralOptionsPage):
        ...
        GeneralOptionsPage.resize(403, 744)
...
"QCheckBox { color: black }")
        ...
        self.program_update_check_group = QtWidgets.QGroupBox(parent=GeneralOptionsPage)
        self.program_update_check_group.setEnabled(True)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Policy.Preferred, QtWidgets.QSizePolicy.Policy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.program_update_check_group.sizePolicy().hasHeightForWidth())
        self.program_update_check_group.setSizePolicy(sizePolicy)
        self.program_update_check_group.setObjectName("program_update_check_group")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.program_update_check_group)
        ...
        self.vboxlayout.addWidget(self.program_update_check_group)
    ...
    def retranslateUi(self, GeneralOptionsPage):
        ...
        self.program_update_check_group.setTitle(_("Update Checking"))
