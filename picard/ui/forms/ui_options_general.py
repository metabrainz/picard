...
class Ui_GeneralOptionsPage(object):
    def setupUi(self, GeneralOptionsPage):
        ...
        self.remove_complete_albums_after_save = QtWidgets.QCheckBox(parent=self.general_box)
    ...
    def retranslateUi(self, GeneralOptionsPage):
        ...
        self.remove_complete_albums_after_save.setText(_("Remove complete albums after saving"))
