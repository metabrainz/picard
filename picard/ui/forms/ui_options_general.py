...
class Ui_GeneralOptionsPage(object):
    def setupUi(self, GeneralOptionsPage):
        ...
        self.remove_complete_albums_after_save = QtWidgets.QCheckBox(parent=GeneralOptionsPage)
        self.remove_complete_albums_after_save.setObjectName("remove_complete_albums_after_save")
        self.vboxlayout.addWidget(self.remove_complete_albums_after_save)
        ...
        GeneralOptionsPage.setTabOrder(self.enable_user_collections, self.remove_complete_albums_after_save)
