...
"QCheckBox { color: black }")
        ...
        self.read_isrcs_from_disc = QtWidgets.QCheckBox(parent=self.submission_box)
        self.read_isrcs_from_disc.setObjectName("read_isrcs_from_disc")
        self.verticalLayout_2.addWidget(self.read_isrcs_from_disc)
        ...
        GeneralOptionsPage.setTabOrder(self.ignore_file_mbids, self.read_isrcs_from_disc)
        GeneralOptionsPage.setTabOrder(self.read_isrcs_from_disc, self.submit_isrcs)
