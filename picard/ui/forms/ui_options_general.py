...
"QCheckBox { color: black }")
        ...
        self.check_rtd_updates = QtWidgets.QCheckBox(parent=self.update_check_groupbox)
        ...
        self.check_for_plugin_updates = QtWidgets.QCheckBox(parent=self.program_update_check_group)
        self.check_for_plugin_updates.setObjectName("check_for_plugin_updates")
        self.verticalLayout_6.addWidget(self.check_for_plugin_updates)
        ...
        GeneralOptionsPage.setTabOrder(self.check_rtd_updates, self.check_for_plugin_updates)
