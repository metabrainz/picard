...
class Ui_AdvancedOptionsPage(object):
    def setupUi(self, AdvancedOptionsPage):
        ...
        self.label_test_file_path_matching = QtWidgets.QLabel(parent=AdvancedOptionsPage)
        self.label_test_file_path_matching.setObjectName("label_test_file_path_matching")
        self.vboxlayout.addWidget(self.label_test_file_path_matching)
        self.test_file_path_matching = QtWidgets.QPlainTextEdit(parent=AdvancedOptionsPage)
        self.test_file_path_matching.setObjectName("test_file_path_matching")
        self.vboxlayout.addWidget(self.test_file_path_matching)
    ...
    def retranslateUi(self, AdvancedOptionsPage):
        ...
        self.label_test_file_path_matching.setText(_("Test file path matching:"))
