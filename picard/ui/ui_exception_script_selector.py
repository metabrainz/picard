...
class Ui_ExceptionScriptSelector(object):
    def setupUi(self, ExceptionScriptSelector):
        ...
        self.threshold_explanation = QtWidgets.QLabel(ExceptionScriptSelector)
        self.threshold_explanation.setText("")
        self.threshold_explanation.setWordWrap(True)
        self.threshold_explanation.setObjectName("threshold_explanation")
        self.verticalLayout.addWidget(self.threshold_explanation)
        self.line = QtWidgets.QFrame(ExceptionScriptSelector)
