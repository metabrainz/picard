...
class Ui_TagsOptionsPage(object):
    def setupUi(self, TagsOptionsPage):
        ...
        self.preserve_image_tags = QtGui.QCheckBox(self.before_tagging)
        self.preserve_image_tags.setObjectName(_fromUtf8("preserve_image_tags"))
        self.vboxlayout1.addWidget(self.preserve_image_tags)
    ...
    def retranslateUi(self, TagsOptionsPage):
        ...
        self.preserve_image_tags.setText(_("Preserve image tags"))
