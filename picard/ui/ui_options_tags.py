...
class Ui_TagsOptionsPage(object):
    def setupUi(self, TagsOptionsPage):
        ...
        self.preserve_tags_checkbox = QtGui.QCheckBox(self.rename_files)
        self.preserve_tags_checkbox.setObjectName(_fromUtf8("preserve_tags_checkbox"))
        self.vboxlayout1.addWidget(self.preserve_tags_checkbox)
    ...
    def retranslateUi(self, TagsOptionsPage):
        ...
        self.preserve_tags_checkbox.setText(_("Preserve Tags"))
