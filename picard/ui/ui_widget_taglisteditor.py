...
class Ui_TagListEditor(object):
    def setupUi(self, TagListEditor):
        ...
        self.tags_remove_btn = QtWidgets.QPushButton(self.edit_buttons)
        self.tags_remove_btn.setObjectName("tags_remove_btn")
        self.horizontalLayout_2.addWidget(self.tags_remove_btn)
        self.tags_add_btn = QtWidgets.QPushButton(self.edit_buttons)
        ...
        self.sort_buttons = QtWidgets.QWidget(TagListEditor)
        self.sort_buttons.setObjectName("sort_buttons")
        self.verticalLayout_2 = QtWidgets.QVBoxLayout(self.sort_buttons)
        self.verticalLayout_2.setContentsMargins(0, 0, 0, 0)
        self.verticalLayout_2.setObjectName("verticalLayout_2")
        spacerItem1 = QtWidgets.QSpacerItem(20, 40, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
        self.verticalLayout_2.addItem(spacerItem1)
        self.tags_move_up_btn = QtWidgets.QPushButton(self.sort_buttons)
        ...
        self.tags_move_down_btn = QtWidgets.QPushButton(self.sort_buttons)
        ...
        self.horizontalLayout.addWidget(self.sort_buttons)
