...
class Ui_CoverOptionsPage(object):
    def setupUi(self, CoverOptionsPage):
        ...
        self.cover_overwrite_prompt = QtGui.QCheckBox(self.location)
        self.cover_overwrite_prompt.setObjectName(_fromUtf8("cover_overwrite_prompt"))
        self.vboxlayout.addWidget(self.cover_overwrite_prompt)
    ...
    def retranslateUi(self, CoverOptionsPage):
        ...
        self.cover_overwrite_prompt.setText(_("Ask before overwriting cover image"))
