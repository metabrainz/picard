...
class Ui_CoverOptionsPage(object):
    def setupUi(self, CoverOptionsPage):
        ...
        self.caprovider_local = QtGui.QCheckBox(self.groupBox)
        self.caprovider_local.setObjectName(_fromUtf8("caprovider_local"))
        self.verticalLayout_2.addWidget(self.caprovider_local)
    ...
    def retranslateUi(self, CoverOptionsPage):
        ...
        self.caprovider_local.setText(_("Local files"))
