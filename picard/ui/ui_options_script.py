...
class Ui_ScriptingOptionsPage(object):
    def setupUi(self, ScriptingOptionsPage):
        ...
        self.script_list = QtGui.QListWidget(self.enable_tagger_script)
        ...
        self.script_tools = QtGui.QGroupBox(self.enable_tagger_script)
    ...
    def retranslateUi(self, ScriptingOptionsPage):
        self.enable_tagger_script.setTitle(_("Tagger Script(s)"))
