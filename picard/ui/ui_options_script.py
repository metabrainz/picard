...
class Ui_ScriptingOptionsPage(object):
    def setupUi(self, ScriptingOptionsPage):
        ...
        self.rename_button = QtWidgets.QToolButton(self.enable_tagger_scripts)
        ...
        self.add_button.clicked.connect(ScriptingOptionsPage.add_script)
        self.tagger_script.textChanged.connect(ScriptingOptionsPage.live_update_and_check)
        self.script_name.textChanged['QString'].connect(ScriptingOptionsPage.script_name_changed)
    ...
    def retranslateUi(self, ScriptingOptionsPage):
        ...
        self.rename_button.setText(_("Rename script"))
