...
class Ui_MovingOptionsPage(object):
    def setupUi(self, MovingOptionsPage):
        ...
        self.gridlayout.addWidget(self.delete_empty_dirs, 4, 0, 1, 1)
        self.copy_files = QtGui.QCheckBox(MovingOptionsPage)
        self.copy_files.setObjectName(_fromUtf8("copy_files"))
        self.gridlayout.addWidget(self.copy_files, 3, 0, 1, 1)
    ...
    def retranslateUi(self, MovingOptionsPage):
        ...
        self.copy_files.setText(_("Copy Files (leave source files untouched)"))
