...
class Ui_fileDialog(object):
    def setupUi(self, fileDialog):
        ...
        self.gridLayout.addWidget(self.fileTree, 1, 1, 1, 7)
        ...
        self.gridLayout.addWidget(self.formatsCb, 3, 7, 1, 1)
        ...
        self.diskList = QtWidgets.QListWidget(fileDialog)
        self.diskList.setObjectName("diskList")
        self.gridLayout.addWidget(self.diskList, 0, 0, 2, 1)
