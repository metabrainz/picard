...
class Ui_PluginsOptionsPage(object):
    def setupUi(self, PluginsOptionsPage):
        ...
        self.set_execution_order = QtWidgets.QPushButton(self.groupBox_2)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.set_execution_order.sizePolicy().hasHeightForWidth())
        self.set_execution_order.setSizePolicy(sizePolicy)
        self.set_execution_order.setObjectName("set_execution_order")
        self.horizontalLayout.addWidget(self.set_execution_order)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 653, 88))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        PluginsOptionsPage.setTabOrder(self.reload_list_of_plugins, self.set_execution_order)
        PluginsOptionsPage.setTabOrder(self.set_execution_order, self.scrollArea)
    ...
    def retranslateUi(self, PluginsOptionsPage):
        ...
        self.install_plugin.setToolTip(_("Install a plugin"))
        self.install_plugin.setText(_("Install…"))
        self.folder_open.setToolTip(_("Open plugin folder"))
        self.folder_open.setText(_("Folder"))
        self.reload_list_of_plugins.setToolTip(_("Reload list of plugins"))
        self.reload_list_of_plugins.setText(_("Reload"))
        self.set_execution_order.setToolTip(_("Set the execution order of the plugins"))
        self.set_execution_order.setText(_("Exec Order..."))
