...
class Ui_PluginsOptionsPage(object):
    def setupUi(self, PluginsOptionsPage):
        ...
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.update_plugin.sizePolicy().hasHeightForWidth())
        self.update_plugin.setSizePolicy(sizePolicy)
        self.update_plugin.setObjectName(_fromUtf8("update_plugin"))
        self.horizontalLayout.addWidget(self.update_plugin)
    ...
    def retranslateUi(self, PluginsOptionsPage):
        ...
        self.update_plugin.setText(_("Update plugin"))
