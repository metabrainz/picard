...
class Ui_PluginsOptionsPage(object):
    def setupUi(self, PluginsOptionsPage):
        ...
        self.plugins.headerItem().setTextAlignment(1, QtCore.Qt.AlignCenter)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 653, 91))
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
    ...
    def retranslateUi(self, PluginsOptionsPage):
        ...
        self.plugins.headerItem().setText(0, _("Name/Version"))
        self.plugins.headerItem().setText(1, _("Actions"))
