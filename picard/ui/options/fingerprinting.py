...
class FingerprintingOptionsPage(OptionsPage):
    ...
    options = [
        ...
        config.BoolOption("setting", "auto_submit", False),
    ]
    ...
    def load(self):
        ...
        self.ui.auto_submit.setChecked(config.setting["auto_submit"])
    ...
    def save(self):
        ...
        config.setting["auto_submit"] = self.ui.auto_submit.isChecked()
