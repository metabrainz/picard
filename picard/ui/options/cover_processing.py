...
class CoverProcessingOptionsPage(OptionsPage):
    ...
    def load(self):
        ...
        self.ui.cover_image_quality_value.setValue(config.setting['cover_image_quality'])
    ...
    def save(self):
        ...
        config.setting['cover_image_quality'] = self.ui.cover_image_quality_value.value()
