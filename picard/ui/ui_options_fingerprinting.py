...
class Ui_FingerprintingOptionsPage(object):
    def setupUi(self, FingerprintingOptionsPage):
        ...
        self.ignore_existing_acoustid = QtGui.QCheckBox(self.acoustid_settings)
        self.ignore_existing_acoustid.setObjectName(_fromUtf8("ignore_existing_acoustid"))
        self.verticalLayout_2.addWidget(self.ignore_existing_acoustid)
    ...
    def retranslateUi(self, FingerprintingOptionsPage):
        ...
        self.ignore_existing_acoustid.setText(_("Ignore existing AcoustID tags"))
