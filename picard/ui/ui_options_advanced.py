...
class Ui_AdvancedOptionsPage(object):
    def setupUi(self, AdvancedOptionsPage):
        ...
        self.label_request_limit = QtWidgets.QLabel(self.groupBox)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_request_limit.sizePolicy().hasHeightForWidth())
        self.label_request_limit.setSizePolicy(sizePolicy)
        self.label_request_limit.setObjectName("label_request_limit")
        self.horizontalLayout_2.addWidget(self.label_request_limit)
        self.query_limit = QtWidgets.QSpinBox(self.groupBox)
        self.query_limit.setAccelerated(True)
        self.query_limit.setMinimum(1)
        self.query_limit.setMaximum(100)
        self.query_limit.setProperty("value", 50)
    ...
    def retranslateUi(self, AdvancedOptionsPage):
        ...
        self.label_request_limit.setText(_("Max. number of entities to return per MusicBrainz query"))
