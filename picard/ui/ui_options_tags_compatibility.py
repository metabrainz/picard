...
class Ui_TagsCompatibilityOptionsPage(object):
    def setupUi(self, TagsCompatibilityOptionsPage):
        ...
        self.wave_riff_info_enc_iso88591 = QtWidgets.QRadioButton(self.wave_riff_info_encoding)
        self.wave_riff_info_enc_iso88591.setChecked(True)
        self.wave_riff_info_enc_iso88591.setObjectName("wave_riff_info_enc_iso88591")
        self.horizontalLayout_3.addWidget(self.wave_riff_info_enc_iso88591)
