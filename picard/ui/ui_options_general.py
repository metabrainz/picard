...
class Ui_GeneralOptionsPage(object):
    def setupUi(self, GeneralOptionsPage):
        ...
        self.file_import_threshold = QtGui.QSpinBox(self.import_settings)
        self.file_import_threshold.setMinimum(1)
        self.file_import_threshold.setMaximum(100000000)
        self.file_import_threshold.setProperty("value", 5000)
        self.file_import_threshold.setObjectName(_fromUtf8("file_import_threshold"))
        self.VImportLayout.addWidget(self.file_import_threshold, 0, 1, 1, 1)
