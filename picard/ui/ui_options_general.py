...
class Ui_GeneralOptionsPage(object):
    def setupUi(self, GeneralOptionsPage):
        ...
        self.import_settings = QtGui.QGroupBox(GeneralOptionsPage)
        self.import_settings.setObjectName(_fromUtf8("import_settings"))
        self.VImportLayout = QtGui.QGridLayout(self.import_settings)
        self.VImportLayout.setSpacing(2)
        self.VImportLayout.setObjectName(_fromUtf8("VImportLayout"))
        self.file_import_warning_threshold = QtGui.QSpinBox(self.import_settings)
        self.file_import_warning_threshold.setMinimum(1)
        self.file_import_warning_threshold.setMaximum(100000000)
        self.file_import_warning_threshold.setProperty("value", 5000)
        self.file_import_warning_threshold.setObjectName(_fromUtf8("file_import_warning_threshold"))
        self.VImportLayout.addWidget(self.file_import_warning_threshold, 0, 1, 1, 1)
        self.label_import = QtGui.QLabel(self.import_settings)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.label_import.sizePolicy().hasHeightForWidth())
        self.label_import.setSizePolicy(sizePolicy)
        self.label_import.setObjectName(_fromUtf8("label_import"))
        self.VImportLayout.addWidget(self.label_import, 0, 0, 1, 1)
        spacerItem1 = QtGui.QSpacerItem(181, 21, QtGui.QSizePolicy.Minimum, QtGui.QSizePolicy.Expanding)
        self.VImportLayout.addItem(spacerItem1)
        self.vboxlayout.addWidget(self.import_settings)
