...
class Ui_MetadataOptionsPage(object):
    def setupUi(self, MetadataOptionsPage):
        ...
        self.translate_artist_names_exception = QtWidgets.QCheckBox(self.metadata_groupbox)
        self.translate_artist_names_exception.setEnabled(False)
        self.translate_artist_names_exception.setObjectName("translate_artist_names_exception")
        self.verticalLayout_3.addWidget(self.translate_artist_names_exception)
        self.artist_locale_exception = QtWidgets.QComboBox(self.metadata_groupbox)
        self.artist_locale_exception.setEnabled(False)
        self.artist_locale_exception.setObjectName("artist_locale_exception")
        self.verticalLayout_3.addWidget(self.artist_locale_exception)
        ...
        self.translate_artist_names.toggled['bool'].connect(self.artist_locale.setEnabled)
        self.translate_artist_names.toggled['bool'].connect(self.translate_artist_names_exception.setEnabled)
        self.translate_artist_names.toggled['bool'].connect(self.artist_locale_exception.setEnabled)
        ...
        MetadataOptionsPage.setTabOrder(self.artist_locale, self.translate_artist_names_exception)
        MetadataOptionsPage.setTabOrder(self.translate_artist_names_exception, self.artist_locale_exception)
        MetadataOptionsPage.setTabOrder(self.artist_locale_exception, self.standardize_artists)
    ...
    def retranslateUi(self, MetadataOptionsPage):
        ...
        self.translate_artist_names_exception.setText(_("Ignore artist name translation for script:"))
