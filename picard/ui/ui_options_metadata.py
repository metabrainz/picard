...
class Ui_MetadataOptionsPage(object):
    def setupUi(self, MetadataOptionsPage):
        ...
        self.translate_artist_names_script_exception.setEnabled(False)
        ...
        self.artist_script_exception = QtWidgets.QComboBox(self.metadata_groupbox)
        self.artist_script_exception.setEnabled(False)
        self.artist_script_exception.setObjectName("artist_script_exception")
        self.verticalLayout_3.addWidget(self.artist_script_exception)
        ...
        self.translate_artist_names.toggled['bool'].connect(self.translate_artist_names_script_exception.setEnabled)
        self.translate_artist_names.toggled['bool'].connect(self.artist_script_exception.setEnabled)
        ...
        MetadataOptionsPage.setTabOrder(self.translate_artist_names_script_exception, self.artist_script_exception)
        MetadataOptionsPage.setTabOrder(self.artist_script_exception, self.standardize_artists)
    ...
    def retranslateUi(self, MetadataOptionsPage):
        ...
        self.translate_artist_names_script_exception.setText(_("Ignore artist name translation for script:"))
