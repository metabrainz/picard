...
TAG_NAMES = {
    ...
    'web_discogs_artist': N_(u'Discogs Artist Webpage'),
    'web_discogs_label': N_(u'Discogs Label Webpage'),
    'web_discogs_release': N_(u'Discogs Release Webpage'),
    'web_discogs_releasegroup': N_(u'Discogs Release Group Webpage'),
    ...
    '~tagdate': N_(u'Date Tagged'),
    '~totalalbumtracks': N_(u'Album Total Tracks'),
    '~web_coverart': N_(u'Cover Art URL'),
    '~web_musicbrainz_artist': N_(u'MusicBrainz Artist Webpage'),
    '~web_musicbrainz_label': N_(u'MusicBrainz Label Webpage'),
    '~web_musicbrainz_recording': N_(u'MusicBrainz Recording Webpage'),
    '~web_musicbrainz_release': N_(u'MusicBrainz Release Webpage'),
    '~web_musicbrainz_releasegroup': N_(u'MusicBrainz Release Group Webpage'),
    '~web_musicbrainz_work': N_(u'MusicBrainz Release Group Webpage'),
    '~video': N_(u'Video?'),
