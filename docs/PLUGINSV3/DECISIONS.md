...
- Phase 1: Manual check only (`picard-cli plugins check-updates`)
...
- Add `picard-cli plugins clean-config <name>` command for later cleanup
...
picard-cli plugins switch-ref myplugin abc123
