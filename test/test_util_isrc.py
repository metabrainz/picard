...
class TestNormalizeIsrc(PicardTestCase):
    def test_plain(self):
        self.assertEqual('USRC17607839', normalize_isrc('USRC17607839'))

    def test_with_hyphens(self):
        self.assertEqual('USRC17607839', normalize_isrc('US-RC1-76-07839'))
    ...
    def test_mixed_hyphens_and_spaces(self):
        self.assertEqual('GBAYE0000351', normalize_isrc('GB-AYE-00-00351'))

    def test_empty_string(self):
        self.assertEqual('', normalize_isrc(''))
