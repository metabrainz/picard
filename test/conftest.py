...
def _prevent_extension_point_deletion():
    ...
    """
    global _EXTENSION_POINT_PARENT
    ...
    def patched_init(self, label=None):
        ...
        try:
            self.setParent(_EXTENSION_POINT_PARENT)
        except RuntimeError:
            pass
