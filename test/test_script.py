...
class ScriptParserTest(PicardTestCase):
    ...
    def test_script_function_documentation(self):
        ...
        pre, post = markdown.markdown('`XXX`').split('XXX')
    ...
    def test_script_function_documentation__all(self):
        """test script_function_documentation_all() with html and markdown formats"""
        self.reset_registry()
        ...
        self.assertStartswith(docall, '<div class="scriptfuncdoc">' + pre)
